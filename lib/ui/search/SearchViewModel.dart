...
import 'package:search_images_flutter/data/db/model/LocalImage.dart';

import '../../data/api/model/SearchImage.dart';
import '../../data/api/model/SearchResponse.dart';
...
class SearchViewModel with ChangeNotifier {
  ...
  Future<void> searchImages(String query, int page) async {
    try {
      SearchResponse result =
          await NetworkRepository().searchImages(query, page);
  ...
  Future<void> insertImage(SearchImage image) async {
    var result = await _provider.insertImage(LocalImage(
